...
let HeaderComponent = class HeaderComponent {
    constructor(_title, _meta) {
        this._title = _title;
        this._meta = _meta;
        this.title = 'Scan & Verify | Sproxil Authentication';
        this.metaDescription = 'Welcome to Sproxil Authentication | Scan & Verify App';
    }
    ngOnInit() {
...
HeaderComponent.propDecorators = {
    ...
    metaDescription: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }]
};
